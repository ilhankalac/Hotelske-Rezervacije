...
<html>
    ...
    <body style="overflow:scroll; overflow-x: hidden;">
        ...
        <form action="Naplacivanje" method="post" style="border-radius: 5px;background:rgba(0,0,0,0.5); color:white; width:50%; margin:0 auto;">
            ...
            <input type="submit" name="NaplacivanjeNovcem" value="Potvrdi plaćanje" class="btn btn-success"> <br> <br>
            ...
            <input type="submit" value="Plati sa <%=request.getAttribute("CenaUPoenima")%> poena" class="btn btn-warning"> <br> <br>  
            <%}
            } else {
                {%> 
